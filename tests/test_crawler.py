...
import pytest
import requests
from crawler import normalize_link, retrieve_links, retrieve_page


@pytest.fixture(scope='function')
def html_page(request):
    """Define a modifiable fixture for an HTML page."""
...
class TestRetrievePage:
    ...
    def test_valid(self):
        ...
        try:
            html = retrieve_page("https://www3.pioneer.com/argentina/PETWS/"
                                 "test.html")
    ...
    def test_invalid(self):
        ...
        try:
            retrieve_page("https://www.google.com/404")
